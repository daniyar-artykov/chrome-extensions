...
function initializeLoginControls(a) {
	if (a && (a = a[LOGIN_DETAILS + selectedFormID])) {
		document.getElementById("usernameId").value = a.usernameId, 
		document.getElementById("j_password").value = a.j_password, 
...
function saveLoginDetails() {
	...
	if(!username) {
		document.getElementById("usernameId").className = document.getElementById("usernameId").className + " highlight-field"; 
	}
	if(!password) {
		document.getElementById("j_password").className = document.getElementById("j_password").className + " highlight-field"; 
	}
...
function saveJourneyPlanDetails() {
	...
	journeyDate = document.getElementById("journeyDateInputDate").value;

	if(!fromStation) {
		document.getElementById("fromStation").className = document.getElementById("fromStation").className + " highlight-field"; 
	}
	if(!toStation) {
		document.getElementById("toStation").className = document.getElementById("toStation").className + " highlight-field"; 
	}
	if(!journeyDate) {
		document.getElementById("journeyDateInputDate").className = document.getElementById("journeyDateInputDate").className + " highlight-field"; 
	}
...
function saveTrainDetails() {
	...
	var quota = $('input[name="qouta"]:checked').val(),
	class1 = $('input[name="class"]:checked').val();

	if(quota === undefined) {
		$( ".quota.radioGroup" ).addClass( "highlight-field" ); 
	}

	if(class1 === undefined) {
		$( ".trainClass.radioGroup" ).addClass( "highlight-field" ); 
	}
...
function savePassengerDetails() {
	var psgnName0 = document.getElementById("psgnName0").value,
	psgnAge0 = document.getElementById("psgnAge0").value,
	psgnGender0 = document.getElementById("psgnGender0").value;

	if(!psgnName0) {
		document.getElementById("psgnName0").className = document.getElementById("psgnName0").className + " highlight-field"; 
	}
	if(!psgnAge0) {
		document.getElementById("psgnAge0").className = document.getElementById("psgnAge0").className + " highlight-field"; 
	}
	if(!psgnGender0) {
		document.getElementById("psgnGender0").className = document.getElementById("psgnGender0").className + " highlight-field"; 
	}
...
function savePaymentDetails() {
	...
	if(paymentType === undefined) {
		$( ".row.radioGroup" ).addClass( "highlight-field" ); 
	}
