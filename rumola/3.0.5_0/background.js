...
function get_regexes_string() {
	...
	var line = "[ck]apt?cha|robot|random|rnd|code|kod|geraimag|verif|captcha||solvemedia||solvemedia||capt?cha|IdMainDiv|realperson||capt?cha||[ck]ap|chal|check|code|kod|confir|guess|guven|ivc|response|secur|solu|spam|test|token|validat|verif|vrfcd|result|respuesta";
	...
	var regexArray = line.split('||');
	for (var i=0; i<regexArray.length; i++) {
		regex[i] = new RegExp(regexArray[i], "i");
	}
